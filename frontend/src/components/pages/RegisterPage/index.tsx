    ...
    <section className='w-full pb-5 bg-gray-100 lg:flex lg:p-0'>
      <div className='bg-primary w-full h-72 p-10 lg:w-2/4 lg:h-screen relative'>
        ...
        <div className='mt-10 lg:mt-16 lg:ml-16 xl:mt-20 xl:mtl-20'>
          <p className='text-2xl xl:text-4xl'>Já tem uma conta?</p>
          <a href="#" className='underline text-xl xl:text-2xl'>Entrar na conta!</a>
        </div>
        <Image
      ...
      <Style.WrapperForm>
        ...
        <p className='text-gray-500 mb-5'>Preencha com suas credenciais para criar sua conta.</p>
        <RegisterForm />
