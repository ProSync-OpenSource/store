    ...
    <Style.HomeContainer>
      ...
      <section className="w-full bg-base-color">
        ...
        >
          <h3
            ref={(e) => {
              productSectionTitleRef.current[0] = e
            }}
            className="text-gray-900 relative font-semibold text-[22px] py-3 max-[900px]:text-[19px] max-[550px]:text-base"
          >
            Da loja para a sua casa
          </h3>
          <div className="flex flex-row place-items-center justify-center gap-x-1 cursor-pointer">
            <span className="text-gray-900 font-semibold text-base leading-none max-[550px]:text-sm">
              Ver todos
            </span>
            <Image
              src={Arrow_right}
      ...
      <section className="w-full flex flex-col gap-y-10">
        <Style.ProductsSectionTitleBox
          afterElementWidth={sectionTitleWidth.element2}
        >
          <h3
            ref={(e) => {
              productSectionTitleRef.current[1] = e
            }}
            className="text-gray-900 relative font-semibold text-[22px] top-0 py-3 max-[900px]:text-[19px] max-[550px]:text-base"
          >
      ...
      <section className="w-full bg-base-color mt-[30px]">
        <Style.ProductsSectionTitleBox
          afterElementWidth={sectionTitleWidth.element3}
          ref={productOffersRef}
        >
          <h3
            ref={(e) => {
              productSectionTitleRef.current[2] = e
            }}
            className="text-gray-900 relative font-semibold text-[22px] py-3 max-[900px]:text-[19px] max-[550px]:text-base"
          >
            Ofertas do dia para você
          </h3>
          <div className="flex flex-row place-items-center justify-center gap-x-1 cursor-pointer">
            <span className="text-gray-900 font-semibold text-base leading-none max-[550px]:text-sm">
              Ver todos
