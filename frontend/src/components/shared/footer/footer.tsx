  ...
  return (
    <FooterContainer>
      <div className="w-full order-1">
        <h2 className="font-bold text-white text-4xl max-[900px]:text-3xl max-[550px]:text-2xl">
          ProSync
        </h2>
        ...
        <div className="mt-8 flex flex-col justify-start items-start text-lg text-white font-bold gap-y-3 max-[550px]:gap-y-2 max-[550px]:text-base">
          ...
          <h3>
            E-mail: <span className="font-normal">suporte@prosync.com.br</span>
          </h3>
          <h3>
            Whatsapp: <span className="font-normal">+55 00 0000-0000</span>
          </h3>
      ...
      <div className="w-full col-span-3 mt-10 flex flex-row order-4 justify-between items-center gap-x-16 max-[750px]:col-span-2 max-[750px]:mt-0 max-[550px]:flex-col max-[550px]:col-span-1 max-[550px]:items-start max-[550px]:gap-y-10">
        <p className="text-sm font-medium text-gray-100">
          ...
          podendo variar com o tempo da oferta. Evite comprar em lojas suspeitas
          ou de origem duvidosa, caso ache que esta sendo enganado ligue: 0800
        </p>

        <div className="flex min-w-52 flex-col justify-center items-center gap-y-4 max-[550px]:items-start">
          <h3 className="text-sm text-gray-100 text-center w-full font-medium whitespace-nowrap max-[550px]:text-left">
            Formas de pagamento
          </h3>
