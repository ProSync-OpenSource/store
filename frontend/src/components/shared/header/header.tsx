...
export function Header() {
  const menuInputsRef: MutableRefObject<null[] | HTMLElement[]> = useRef([
    null,
    null
  ])
  const [isDropDownMenuActive, setIsDropDownMenuActive] =
    useState<DropDownElementProps>({
      firstDropDown: false,
    ...
    <section className="drawer">
      ...
      <div className="drawer-content">
        <header className="w-full text-white flex flex-col justify-start items-center">
          <Style.HeaderNavBar>
            <div className="w-fit">
              <h1 className="text-white font-semibold text-[35px] flex items-baseline max-[800px]:hidden">
                ProSync
              </h1>
            ...
            <nav>
              <ul className="w-full flex flex-row gap-x-5 items-center justify-end">
                <li className="flex flex-row items-center gap-x-2 max-[550px]:hidden">
                  ...
                  <span className="text-lg font-semibold cursor-pointer max-[800px]:hidden">
                    Login
                  </span>
                </li>
                ...
                <li className="relative cart-icon-box">
                  ...
                  <div className="w-3 h-3 rounded-full bg-base-color absolute -top-2/4 -right-2/4 font-normal text-[8px] text-gray-900 flex items-center justify-center">
                    1
                  </div>
                </li>
              </ul>
            ...
            <nav className="w-full flex justify-center items-center">
              <Style.CategoryList>
                <Style.CategoryListItem
                  ...
                  zIndex={isDropDownMenuActive.firstDropDown ? 50 : 10}
                >
                  <span className="h-5 leading-none text-[16px]">Casa</span>
                  <IoIosArrowDown />
                  <div
                    style={
                      isDropDownMenuActive.firstDropDown
                        ? { maxHeight: '400px' }
                        : { maxHeight: '0px' }
                    }
                    className="absolute top-full z-40 left-0 min-w-full overflow-y-hidden ease-out duration-100 max-[900px]:hidden"
                  >
                    <div className="bg-white mt-2 rounded-md py-2 px-1 relative">
                      ...
                      <ul className="w-auto flex flex-col items-start justify-start gap-y-1 overflow-hidden">
                        <li
                          style={{ width: '100%' }}
                          className="text-gray-700 font-medium text-[15px] py-1 rounded-[4px] hover:text-white px-2 hover:bg-primary whitespace-nowrap"
                        >
                ...
                <Style.CategoryListItem
                  ...
                  zIndex={isDropDownMenuActive.secondDropDown ? 50 : 10}
                >
                  <span className="h-5 leading-none text-[16px]">Esportes</span>
                  <IoIosArrowDown />
                  <div
                    style={
                      isDropDownMenuActive.secondDropDown
                        ? { maxHeight: '400px' }
                        : { maxHeight: '0px' }
                    }
                    className="absolute top-full z-40 left-0 min-w-full overflow-y-hidden ease-out duration-100 max-[900px]:hidden"
                  >
                    <div className="py-2 px-1 bg-white mt-2 relative rounded-md">
                      ...
                      <ul className="w-auto flex flex-col items-start justify-start gap-y-1">
                        <li
                          style={{ width: '100%' }}
                          className="text-gray-700 font-medium text-[15px] py-1 px-2 rounded-[4px] hover:bg-primary hover:text-white whitespace-nowrap"
                        >
                          Roupas e Calçados
                        </li>
                        <li
                ...
                <Style.CategoryListItem
                  ...
                  zIndex={isDropDownMenuActive.thirdDropDown ? 50 : 10}
                >
                  <span className="h-5 leading-none text-[16px]">Moda</span>
                  <IoIosArrowDown />
                  <div
                    style={
                      isDropDownMenuActive.thirdDropDown
                        ? { maxHeight: '400px' }
                        : { maxHeight: '0px' }
                    }
                    className="absolute top-full z-40 left-0 min-w-full overflow-y-hidden ease-out duration-100 max-[900px]:hidden"
                ...
                <Style.CategoryListItem
                  ...
                  zIndex={isDropDownMenuActive.fourthDropDown ? 50 : 10}
                >
                  <span className="h-5 leading-none text-[16px]">
                    Tecnologia
                  </span>
                  <IoIosArrowDown />
                  <div
                    style={
                      isDropDownMenuActive.fourthDropDown
                        ? { maxHeight: '400px' }
                        : { maxHeight: '0px' }
                    }
                    className="absolute top-full z-40 left-0 min-w-full overflow-y-hidden ease-out duration-100 max-[900px]:hidden"
                ...
                <Style.CategoryListItem
                  ...
                  zIndex={isDropDownMenuActive.fifthDropDown ? 50 : 10}
                >
                  <span className="h-5 leading-none text-[16px]">Fitness</span>
                  <IoIosArrowDown />
                  <div
                    style={
                      isDropDownMenuActive.fifthDropDown
                        ? { maxHeight: '400px' }
                        : { maxHeight: '0px' }
                    }
                    className="absolute top-full z-40 left-0 min-w-full overflow-y-hidden ease-out duration-100 max-[900px]:hidden"
                ...
                <Style.CategoryListItem
                  ...
                  zIndex={isDropDownMenuActive.sixthDropDown ? 50 : 10}
                >
                  <span className="h-5 leading-none text-[16px]">Ofertas</span>
                  <IoIosArrowDown />
                  <div
                    style={
                      isDropDownMenuActive.sixthDropDown
                        ? { maxHeight: '400px' }
                        : { maxHeight: '0px' }
                    }
                    className="absolute top-full z-40 left-0 min-w-full overflow-y-hidden ease-out duration-100 max-[900px]:hidden"
                  >
                    <div className="p-1 bg-white mt-2 relative rounded-lg">
                      ...
                      <ul className="w-auto flex flex-col items-start justify-start gap-y-1">
                        <li
                          style={{ width: '100%' }}
                          className="text-gray-700 font-medium text-[15px] py-1 px-2 rounded-[4px] hover:bg-primary hover:text-white"
                        >
                          Ofertas do dia
                        </li>
                        <li
          ...
          <Style.OverlayElement
            zIndex={isDropDownMenuActive.isOverlayActive ? 40 : -10}
            opacity={isDropDownMenuActive.isAnyDropDownActive ? 0.3 : 0}
          ></Style.OverlayElement>
        </header>
      </div>
